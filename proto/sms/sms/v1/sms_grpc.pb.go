...
func (c *sMSServiceClient) Send(ctx context.Context, in *SendRequest, opts ...grpc.CallOption) (*SendResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sms.sms.v1.SMSService/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sMSServiceClient) Validation(ctx context.Context, in *ValidationRequest, opts ...grpc.CallOption) (*ValidationResponse, error) {
	out := new(ValidationResponse)
	err := c.cc.Invoke(ctx, "/sms.sms.v1.SMSService/Validation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSMSServiceServer) Validation(context.Context, *ValidationRequest) (*ValidationResponse, error) {
...
func _SMSService_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sms.sms.v1.SMSService/Send",
	}
...
func _SMSService_Validation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ValidationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SMSServiceServer).Validation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sms.sms.v1.SMSService/Validation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SMSServiceServer).Validation(ctx, req.(*ValidationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SMSService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sms.sms.v1.SMSService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SMSService_Validation_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "sms/sms/v1/sms.proto",
}
