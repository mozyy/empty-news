...
func (NewsGORM) TableName() string {
	return "news_news"
}

// ToPB  converts the fields of this object to PB object
func (m *NewsGORM) ToPB(ctx context.Context) *News {
	to := News{}
	to.ID = m.ID
	to.Link = m.Link
	to.Image = m.Image
...
func (m *News) ToORM(ctx context.Context) *NewsGORM {
	to := NewsGORM{}
	to.ID = m.GetID()
	to.Link = m.GetLink()
	to.Image = m.GetImage()
...
func (DetailResponse_DetailContentGORM) TableName() string {
	return "news_detail_response_detail_contents"
}
