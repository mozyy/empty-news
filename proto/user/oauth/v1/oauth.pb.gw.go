...
/*
Package oauthv1 is a reverse proxy.
...
func request_OAuthService_Valid_0(ctx context.Context, marshaler runtime.Marshaler, client OAuthServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_OAuthService_Valid_0(ctx context.Context, marshaler runtime.Marshaler, server OAuthServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ValidRequest
	var metadata runtime.ServerMetadata
...
func RegisterOAuthServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OAuthServiceServer) error {
	...
	mux.Handle("POST", pattern_OAuthService_Token_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/user.oauth.v1.OAuthService/Token", runtime.WithHTTPPathPattern("/user.oauth.v1.OAuthService/Token"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_OAuthService_Token_0(ctx, inboundMarshaler, server, req, pathParams)
		...
		forward_OAuthService_Token_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)

	})

	mux.Handle("POST", pattern_OAuthService_Valid_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/user.oauth.v1.OAuthService/Valid", runtime.WithHTTPPathPattern("/user.oauth.v1.OAuthService/Valid"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_OAuthService_Valid_0(ctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
		...
		forward_OAuthService_Valid_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterOAuthServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OAuthServiceClient) error {
	...
	mux.Handle("POST", pattern_OAuthService_Token_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/user.oauth.v1.OAuthService/Token", runtime.WithHTTPPathPattern("/user.oauth.v1.OAuthService/Token"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_OAuthService_Token_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("POST", pattern_OAuthService_Valid_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/user.oauth.v1.OAuthService/Valid", runtime.WithHTTPPathPattern("/user.oauth.v1.OAuthService/Valid"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_OAuthService_Valid_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_OAuthService_Token_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"user.oauth.v1.OAuthService", "Token"}, ""))

	pattern_OAuthService_Valid_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"user.oauth.v1.OAuthService", "Valid"}, ""))
)

var (
	forward_OAuthService_Token_0 = runtime.ForwardResponseMessage

	forward_OAuthService_Valid_0 = runtime.ForwardResponseMessage
)
